					...
					<div class="card-body">
						...
						<div class="d-flex flex-wrap justify-content-around pb-2 pt-4">
							<div class="px-2 pb-2 pb-md-0 text-center">
								...
								<button type="button" class="btn btn-success btn-sm btn-round m-2" data-toggle="modal" data-target="#post-create">
									<i class="fa fa-plus"></i> Post
								 </button>
								 @include('admin.content.posts.modal_create')
							</div>
							<div class="px-2 pb-2 pb-md-0 text-center">
								<div id="circles-2"></div>
								<h6 class="fw-bold mt-3 mb-0">Users</h6>
								<button type="button" class="btn btn-success btn-sm btn-round m-2" data-toggle="modal" data-target="#exampleModal">
									<i class="fa fa-plus"></i> User
								 </button>
								 @include('admin.users.create')
								{{-- <a href="/user/create" class="btn btn-success btn-sm btn-round text-white m-2"><i class="fa fa-plus"></i> User</a> --}}
							</div>
							<div class="px-2 pb-2 pb-md-0 text-center">
