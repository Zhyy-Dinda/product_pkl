                    ...
                    <div class="quick-actions-scroll scrollbar-outer">
                        <div class="quick-actions-items">
                            <div class="row m-0">
                                ...
                                <a class="col-6 col-md-4 p-0" href="/post/create">
                                    <div class="quick-actions-item">
                ...
                <ul class="dropdown-menu dropdown-user animated fadeIn">
                    <div class="dropdown-user-scroll scrollbar-outer">
                        <li>
                            <div class="user-box">
                                <div class="avatar-lg">
                                    <img src="{{ $user && Storage::exists('public/user/'.Auth::user()->image) ? Storage::url('public/user/'.Auth::user()->image) : asset('img/logo/user_profile.png') }}" alt="image profile" class="avatar-img rounded"></div>
                                <div class="u-text">
